      ...
      <section className="relative mx-auto mt-16 w-full max-w-xl pt-4">
        ...
        <div className="overflow-hidden rounded-[28px] bg-white text-ink">
          ...
          <div className="px-6 py-10 sm:px-10">
            ...
            <div className="mt-8 space-y-2 font-display text-xl font-extrabold">
            ...
            <Link
              href="/"
              className="mt-10 inline-flex rounded-full bg-lime px-6 py-3 font-display font-extrabold text-ink hover:bg-lime-deep"
            >
              Voltar ao início
            </Link>
          </div>
